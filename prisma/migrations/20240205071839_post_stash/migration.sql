/*
  ...
  - You are about to drop the `UserProgressData` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "UserProgressData" DROP CONSTRAINT "UserProgressData_userId_fkey";

-- DropTable
DROP TABLE "UserProgressData";
